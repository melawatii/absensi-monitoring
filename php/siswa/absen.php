...
<head>
    ...
    <title>Isi Kehadiran | ABSEN MONITORING</title>
    <!-- Icon -->
...
<body>
    ...
    <div class="back">
        <div class="btn-back">
            <a href="loginsiswa.php" class="btn read"><i class="fas fa-angle-double-left"></i></a>
        </div>
    </div>
    <!-- ----- Penutup Button Kembali ----- -->

    <div class="container">
    <!-- ----- Pembuka Form Absen Siswa ----- -->
    <div class="form">
        <div class="image-content">
            <img src="../../img/undraw_smart_home_re_orvn.png" class="box">
        </div>
        <div class="form-content">
            <form action="prosesabsen.php" method="POST" enctype="multipart/form-data">
                <table class="form-absen" cellpadding="10" class="box">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <input type="number" name="nis" required placeholder="Masukkan NIS ..." autocomplete="off">
                        </td>
                    </tr>
                    <tr>
                        <td>Nama Lengkap</td>
                        <td>:</td>
                        <td>
                            <input type="text" name="nama" required placeholder="Masukkan Nama ..." autocomplete="off" >
                        </td>
                    </tr>
                    <tr>
                        <td>Rayon</td>
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td><button class="btn-home" name="submit"><i class="fas fa-share"></i>Kirim</button></td>
                    </tr>
                </table>
            </form>
        </div>
    </div>
    <!-- ----- Penutup Form Absen Siswa ----- -->
    </div>
