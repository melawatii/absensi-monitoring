...
<head>
    ...
    <title>Tambah Data Kehadiran | ABSEN MONITORING</title>
    <!-- Icon -->
...
<body>
    ...
    <div class="form">
        ...
        <div class="form-content">
            <form action="tambahan.php" method="POST" enctype="multipart/form-data">
                <table class="form-absen" cellpadding="10" class="box">
                    ...
                    <tr>
                        <td></td>
                        <td></td>
                        <td><button class="btn-home" name="submit"><i class="fas fa-share"></i>Simpan</button></td>
                    </tr>
                </table>
            </form>
        </div>
